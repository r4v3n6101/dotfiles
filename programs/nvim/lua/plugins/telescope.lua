return {
    ...
    keys = {
        { "<leader>ff", "<cmd>Telescope find_files initial_mode=normal<cr>",  desc = "Find files [telescope.nvim]" },
        { "<leader>fg", "<cmd>Telescope live_grep initial_mode=normal<cr>",   desc = "Find by grep [telescope.nvim]" },
        { "<leader>fw", "<cmd>Telescope grep_string initial_mode=normal<cr>", desc = "Find by current word [telescope.nvim]" },
